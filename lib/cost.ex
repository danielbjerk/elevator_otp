defmodule Cost do
    def calculate_cost_for_order(order) do
        ...
        try do
            ...
            {elevator_floor, elevator_direction} = Task.await(pTask, 100)
            ...
            try do
                ...
                e -> 
                    IO.inspect(e)
                    IO.inspect("queue poo")
                    :infinite_cost    # Failed to retrieve queue for elevator.
            end
            ...
            e ->
                IO.inspect(e)
                IO.inspect("pos poo")
                :infinite_cost    # Failed to retrieve position for elevator.
        end
